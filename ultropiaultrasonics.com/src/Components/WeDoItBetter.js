    ...
    return (
        <div className={classes.root} id="WhyChange" >
                ...
                <Typography className={classes.heading} >
                    <b>...but traditional washing machines are not equipped for such a challenge.</b>
                </Typography>  

            <Container maxWidth="lg">
                
                <Humanarg
                    top="By 2025 half the world’s population will be living in a water stressed area."
                    bottom="But the average household washing machine uses 5,605 gallons of water each year."
                    image = {dryingriver}
                    alt = "dried river"
                />
                <Humanarg
                    top="One out of every three people do not have access to clean drinking water."
                    bottom="How are they going to wash their clothes with dirty water?"
                    image = {badwater}
                    alt = "unclean drinking water"
                />
                <Humanarg
                    top="One in ten people do not have a reliable source of water close to home."
                    bottom="But a washing machine requires a continuous source of water to clean clothes."
                    image = {waterwalk}
                    alt = "A long walk for water"
                />
                <Humanarg
                    top="Sustainable energy goals are not being met, while 11% of the world are without electricity."
                    bottom="But a household washing machine and dryer on average consume 1,842 pounds of coal annually."
                    image = {coalpower}
